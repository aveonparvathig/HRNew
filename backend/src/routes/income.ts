...
// Academic years
router.get('/academic-years', adminOnly, asyncHandler((req, res) => incomeController.getAcademicYears(req, res)));
router.post('/academic-years', adminOnly, asyncHandler((req, res) => incomeController.createAcademicYear(req, res)));
...
router.delete('/clients/:clientId', adminOnly, asyncHandler((req, res) => incomeController.deleteClient(req, res)));
router.post('/clients/:clientId/toggle-active', adminOnly, asyncHandler((req, res) => incomeController.toggleClientActive(req, res)));
router.post('/clients/:clientId/engineer', adminOnly, asyncHandler((req, res) => incomeController.updateClientEngineer(req, res)));
...
router.delete('/billings/:billingId', adminOnly, asyncHandler((req, res) => incomeController.deleteBilling(req, res)));

// Payments
router.post('/billings/:billingId/payments', asyncHandler((req, res) => incomeController.addPayment(req, res)));
router.delete('/payments/:paymentId', adminOnly, asyncHandler((req, res) => incomeController.deletePayment(req, res)));
...
router.delete('/features/:featureId', adminOnly, asyncHandler((req, res) => incomeController.deleteFeature(req, res)));

// Export / import
router.get('/export.csv', adminOnly, asyncHandler((req, res) => incomeController.exportCsv(req, res)));
router.get('/export.xlsx', adminOnly, asyncHandler((req, res) => incomeController.exportXlsx(req, res)));
router.post('/import', adminOnly, asyncHandler((req, res) => incomeController.importCsv(req, res)));
router.post('/import-xlsx', adminOnly, asyncHandler((req, res) => incomeController.importXlsx(req, res)));
