    ...
    <>
        ...
        actions={
          <>
            <button className="btn btn-secondary" onClick={async () => {
              const res = await apiClient.get('/people/export/employees.csv', { responseType: 'blob' });
      ...
      {data?.employeeStats && employees.length > 0 && (
        <div className="stat-grid">
          ...
          <StatCard label="Monthly Payroll Cost" value={formatINR(data.employeeStats.monthlyCost)}
      ...
      {totalCount === 0 ? (
        ...
        <>
          {employees.length > 0 && (
            <>
              <div className="section-title">Employees ({employees.length})</div>
                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        ...
                        <th>Joined</th><th className="num">Package</th><th>Status</th><th />
                      </tr>
                    </thead>
                    <tbody>
                      {employees.map((p: any) => (
                        <tr key={p.id}>
                          ...
                          <td className="num">{p.currentMonthlyPackage ? formatINR(p.currentMonthlyPackage) : '—'}</td>
                          <td>
